...
- [x] 6.3 Manual keyboard-only walkthrough: tab through feed, trigger H/S shortcuts, confirm buttons appear on focus
- [x] 6.4 Manual touch emulation: confirm buttons are always visible with `(hover: none)` in DevTools
